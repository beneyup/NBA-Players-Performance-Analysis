...
FreeThrowAtttemptsPerGame = np.matrix.round(FreeThrowAttempts/Games)
print(FreeThrowAtttemptsPerGame)
...
#Free Throw Accuracy
FreeThrowAccuracy = np.matrix.round(FreeThrows/FreeThrowAttempts,2)*100
...
def myplot(data,playerlist = Players):
    Col ={"KobeBryant":"Black", "JoeJohnson":"Red", "LeBronJames":"Green", "CarmeloAnthony":"Blue", "DwightHoward":"Magenta", "ChrisBosh":"Purple", "ChrisPaul":"Orange", "KevinDurant":"Brown","DerrickRose":"Yellow","DwayneWade":"Cyan"}
    Mar ={"KobeBryant":"s", "JoeJohnson":"o", "LeBronJames":"^", "CarmeloAnthony":"D", "DwightHoward":"p", "ChrisBosh":"H", "ChrisPaul":"*", "KevinDurant":"+","DerrickRose":"h","DwayneWade":"x"}
...
myplot(FreeThrowAccuracy)


# We can draw the most obvious result from these two graphs above is; Although Dwight Howard did an average job from 2005 to 2014, he was the fewest free throw goalscorers.
...
myplot(Points, ['DwightHoward', 'KevinDurant'])


# In[15]:


myplot(FreeThrowAccuracy, ['DwightHoward', 'KevinDurant'])


# The two graphs above tell us Kevin Durant was quite successful at free throws, even though his point range wasn't that stable he did a good job overall. This might be because he was good at free throws. On the other hand, Dwight Howard wasn't prospering at free throws but he did an average job in general. This might be because he was better at shooting baskets that were worth two or three.
...
# Joe Johnson, Derrick Rose, and Kevin Durant had the most dynamic playing style patterns between 2005 and 2014, while Dwight Howard's style was the most stable among the players we analyzed in this project.
